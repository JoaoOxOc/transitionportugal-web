...
ARG CMS_INTEGRATION_USER
ENV CMS_INTEGRATION_USER=$CMS_INTEGRATION_USER
ARG CMS_INTEGRATION_USER_PASSWORD
ENV CMS_INTEGRATION_USER_PASSWORD=$CMS_INTEGRATION_USER_PASSWORD
