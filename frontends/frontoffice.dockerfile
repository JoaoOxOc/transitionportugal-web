...
ARG NEXT_PUBLIC_HOME_BASE_URL
ENV NEXT_PUBLIC_HOME_BASE_URL=$NEXT_PUBLIC_HOME_BASE_URL
...
ARG HOME_API_BASE_URL
ENV HOME_API_BASE_URL=$HOME_API_BASE_URL
ARG HOME_API_CLIENT_ID
ENV HOME_API_CLIENT_ID=$HOME_API_CLIENT_ID
ARG HOME_API_CLIENT_SECRET
ENV HOME_API_CLIENT_SECRET=$HOME_API_CLIENT_SECRET
