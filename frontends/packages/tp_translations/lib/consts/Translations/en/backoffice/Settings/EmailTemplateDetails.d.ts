export declare const EMAILTEMPLATEDETAILS_TRANSLATIONS: {
    ...
    readonly FORM: {
        readonly key: "Email Template Key";
        readonly templateLanguage: "Email Template Language";
        readonly description: "Description";
        readonly subject: "Email Template Subject";
        readonly bodyMessage: "View/Edit Email Template body";
        readonly bodyEditorLink: "Go to Editor";
    ...
    readonly MESSAGES: {
        ...
        readonly templateGeneralError: "Error updating Email Template with key {{templateKey}}. Please try again";
        readonly templateNotFound: "The Email Template with key {{templateKey}} wasn't found. Please double check if the key is correct";
    };
};
