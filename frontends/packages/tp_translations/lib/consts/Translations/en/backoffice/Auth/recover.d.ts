export declare const RECOVER_TRANSLATIONS: {
    readonly LABELS: {
        readonly pageTitle: "Recover Password - Transição Portugal";
        readonly title: "Recover Password";
        readonly subtitle: "Fill in your username or email to recover your account.";
        readonly closeMessage: "Close Success Message";
        readonly buttonToLogin: "Button link to login page";
        readonly signInLabel: "Want to try to sign in again?";
        readonly signIn: "Click here";
