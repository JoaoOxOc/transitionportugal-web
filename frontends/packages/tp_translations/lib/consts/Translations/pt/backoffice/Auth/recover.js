...
export var RECOVER_TRANSLATIONS = deepFreeze({
    LABELS: {
        pageTitle: "Recuperar Palavra-passe - Transição Portugal",
        title: "Recuperar Palavra-passe",
        subtitle: "Preencha o seu username ou email para recuperar a sua conta.",
        closeMessage: "Fechar Mensagem de Sucesso",
        buttonToLogin: "Botão de link para a página de autenticação",
        signInLabel: "Deseja tentar autenticar-se novamente?",
        signIn: "Clique aqui",
