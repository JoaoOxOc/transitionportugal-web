...
function HeaderUserbox() {
  ...
  return (
    <>
      <Head>
        <title>Authentication - Tokyo White NextJS Javascript Admin Dashboard</title>
      </Head>
        ...
        <Grid container spacing={4}>
          ...
          <Grid item xs={12}>
            <Typography paragraph>
              Tokyo White NextJS Javascript Admin Dashboard includes four separate
            ...
            <Typography paragraph>
              ...
              default, Tokyo White NextJS Javascript Admin Dashboard comes with JWT
              Web Tokens enabled.
            </Typography>
            <Typography paragraph>
